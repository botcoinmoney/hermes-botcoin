...
from hermes_botcoin.solver import (
    DEFAULT_MODELS,
    SYSTEM_PROMPT,
    build_solver_prompt,
)
...
def test_venice_is_the_default():
    """The recommendation lives in DEFAULT_MODELS' ordering / docs, but ensure
    venice has an actual model picked."""
...
def test_solver_prompt_omits_trace_block_when_not_required():
    ...
    out = build_solver_prompt(challenge)
    # The hard requirement banner should not appear
