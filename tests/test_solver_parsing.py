"""Solver output extraction must survive code fences, prose preambles,
nested braces, and decoy JSON before the real artifact."""
...
from hermes_botcoin.solver import _iter_json_objects, _parse_output  # noqa: E402
...
def test_artifact_in_regex_fallback():
    ...
    text = '{"artifact": "fallback-only", "reasoningTrace": [INVALID]'
    art, trace, answers = _parse_output(text)
